...
# from .diffparser import parse_ps,_insert_ps_args,parse_cmd
...
class Request(object):
    ...
    def parse(self):
        ...
        if self.method == 'script':
            self.cmd = parse(self.script, *self.args)

        elif self.method == 'cmd':
            self.cmd = parse_cmd(self.cmd, *self.args)

        elif self.method == 'ps':
            self.cmd = parse_ps(self.cmd, *self.args)
